(function ($) {
  ...
  function pageLoader() {
    ...
    if (siteLoader == true) {
      ...
      loadAn.to(num1wrap, duration, { y: "-91%", ease: "power2.inOut" }, 0.25);
      loadAn.to(
        num2wrap,
        duration,
        { y: "-95.3%", ease: "power2.inOut" },
        0.25
      );
      loadAn.to(num3wrap, 1.5, { y: "0%", ease: "power2.Out" }, 0.5);
      loadAn.to(".site-logo", 1, { y: "0%", ease: "power2.out" }, 2);
      if (siteHeader.hasClass("classic_menu")) {
        gsap.set(".main-menu > li", { overflow: "hidden" });
        loadAn.fromTo(
          ".main-menu > li > a",
          1,
          { y: "100%" },
          {
            ...
            ease: "power2.out",
            onComplete: function () {
              gsap.set(".main-menu > li", { clearProps: "all" });
            },
          },
          3
        );
        ...
        loadAn.to(
          ".toggle-line",
          1,
          { width: 50, ease: "power2.out", stagger: 0.3 },
          3
        );
      }
      loadAn.to(
      ...
      loadAn.to(num3wrap, 1, { y: "-50%", ease: "power2.Out" }, duration - 0.6);
      loadAn.to(
        ".apl-num-wrapper",
        0.6,
        { y: "-100%", ease: "power2.in", stagger: 0.1 },
        duration + 0.6
      );
    } else {
      gsap.set(".site-logo", { y: "0%" });
    ...
    if (pageCursor == true) {
      ...
      function cursorHovers() {
        ...
        if ($("body").hasClass("dark")) {
          gsap.set(cursor, { borderColor: lightCircle });
          gsap.set(dot, { background: lightDot });
          curBg = lightCircle;
          iconColor = lightDot;
        } else {
          gsap.set(cursor, { borderColor: darkCircle });
        ...
        $(".section").on("mouseenter", function () {
          ...
          if (lightness < 50 && lightness != 0) {
            gsap.to(cursor, { borderColor: lightCircle });
            gsap.to(dot, { background: lightDot });
          } else if (lightness > 50 && lightness != 0) {
            gsap.to(cursor, { borderColor: darkCircle });
        ...
        projectHovers.on("mouseenter", function (e) {
          gsap.to(mouseCursor, { width: 120, height: 120 });
          gsap.to(cursor, { backgroundColor: curBg, borderWidth: 0 });
        });
      ...
      barba.hooks.before((data) => {
        cursorLoading = gsap.timeline({ overwrite: true });
        cursorLoading.to(mouseCursor, 0.3, { width: 50, height: 50 }, 0);
        cursorLoading.to(
          cursor,
          0.3,
        ...
        cursorLoading.to(
          dot,
          0.3,
          { opacity: 1, x: "0%", y: "0%", top: "0%", left: "0%" },
          0
        );
        cursorLoading.to(
          dot,
        ...
        cursorLoading.to(
          mouseCursor,
          1,
          { rotate: 360, repeat: -1, ease: "power2.inOut" },
          0
        );
      });
      barba.hooks.after((data) => {
        ...
        cursorLoaded.to(
          dot,
          0.8,
          { top: "50%", left: "50%", ease: "power2.inOut" },
          0.4
        );
      });
    } else {
  ...
  function siteHeaderSet() {
    ...
    if (siteHeader.hasClass("sticky_header")) {
      ...
      if (showcaseScroll) {
        ...
        gsap.set(siteHeader, { position: "fixed" });
        var sitkcyHdr = ScrollTrigger.create({
          ...
          onEnter: function () {
            gsap.set(siteHeader, { position: "absolute", top: stickyStart });
            ScrollTrigger.create({
              ...
              onUpdate: function (self, direction, progress) {
                if (self.direction == -1) {
                  gsap.to(siteHeader, { y: "0%" });
                } else {
                  gsap.to(siteHeader, { y: "-100%" });
                }
              },
          ...
          onEnterBack: function () {
            gsap.set(siteHeader, { position: "fixed", top: 0 });
          },
        });
      } else {
        gsap.set(siteHeader, { position: "absolute" });
        ScrollTrigger.create({
          trigger: "body",
          start: "top+=500 top",
          end: "bottom bottom",
      ...
      menuItem.each(function () {
        ...
        $this.on("mouseenter", function () {
          gsap.fromTo(
            chars,
            { opacity: 0, y: 10 },
            { opacity: 1, y: 0, color: secondColor, stagger: 0.025 }
          );
        });
        $this.on("mouseleave", function () {
          gsap.to(chars, { color: firstColor, stagger: 0.025 });
        });
      });
    }
  }
  ...
  function fullscreenNavigation() {
    if ($(".site-navigation").hasClass("fullscreen")) {
      ...
      var gitButtonAnim = gsap.fromTo(
        ".git-button",
        { translateY: "50%" },
        { translateY: "0%", opacity: 1, paused: true, delay: 1.3 }
      );
      menuToggle.on("click", function () {
        ...
        if (clicks) {
          ...
          if (!mobileQuery.matches) {
            gsap.set(".sub-back", { top: menuTop });
          }
          var rule = CSSRulePlugin.getRule(
            ".site-header.fullscreen_menu.menu-has-open::before"
          );
          if (mobileQuery.matches) {
            gsap.set(rule, { cssRule: { height: "100vh" } });
          } else {
            gsap.set(menuWrapper, { height: menuHeight + plusHeight });
            gsap.set(rule, {
              cssRule: { height: menuHeight + plusHeight + 50 },
            });
          }
    ...
    if (blog.hasClass("blog-list")) {
      post.each(function (i) {
        ...
        $this.on("mouseenter", function () {
          ...
          findImg = "." + imageCheck;
          gsap.fromTo(findImg, { width: "0%" }, { width: "100%" });
        });
        $this.on("mouseleave", function () {
          let imageCheck = $this.data("post");
          findImg = "." + imageCheck;
          gsap.fromTo(findImg, { width: "100%" }, { width: "0%" });
        });
      });
      ...
      imagesImg.each(function (i) {
        ...
        gsap.set(img, { width: width, height: height });
  ...
  function aliothProjectPage() {
    ...
    if (animate == true) {
      ...
      new SplitText(cat, { type: "chars", charsClass: "cat-char" });
      new SplitText(summary, { type: "lines", linesClass: "summ_line" });
      ...
      if (projectHeader.hasClass("style_1")) {
        ...
        gsap.to(".summ_line span", 1.5, {
          ...
          stagger: 0.1,
          ease: "power2.out",
          scrollTrigger: { trigger: ".meta-summary" },
        });
        gsap.to(".project-other span", 1.5, {
          y: "0%",
          stagger: 0.1,
          ease: "power2.out",
          scrollTrigger: { trigger: ".project-other" },
        });
      }
    }
  }
      ...
      cat.on("click", function () {
        ...
        filterAn.fromTo(
          ...
          { width: "0%" },
          {
            ...
            onStart: function () {
              gsap.set(".product-ov", { right: 0, left: "unset" });
            },
            onComplete: function () {
        ...
        filterAn.fromTo(
          ...
          { width: "100%" },
          {
            ...
            ease: "power2.inOut",
            onStart: function () {
              gsap.set(".product-ov", { left: 0, right: "unset" });
            },
            onComplete: function () {
  ...
  function aliothSingleProduct() {
    if ($(".product-page").length) {
      let firstImage = $(".sp-image:first-child > img"),
        ...
        slider = $(".sp-slider");
      gsap.set(slider, { height: firstHeight });
      var productSlider = new Swiper(".sp-slider", {
        slidesPerView: 1,
        navigation: { prevEl: ".sp-next", nextEl: ".sp-prev" },
        pagination: {
          el: ".sp-dots",
          type: "bullets",
          clickable: true,
    ...
    if (scrollNot.length) {
      ...
      scTim.fromTo(
        ...
        { height: 40 },
        {
          ...
          duration: 1,
          onStart: function () {
            gsap.set(scLine, { top: "unset", bottom: "140%" });
          },
        }
      );
      scTim.fromTo(
        ...
        { height: 0 },
        {
          ...
          duration: 1,
          onStart: function () {
            gsap.set(scLine, { bottom: "unset", top: "-125%" });
          },
        }
      );
    }
      ...
      $this.on("mouseenter", function () {
        ...
        gsap.fromTo(
          ...
          { scale: 1.1, opacity: 0 },
          {
            ...
            onStart: function () {
              $(findImg).show();
              gsap.set(".cs-project-image", { zIndex: -1 });
              gsap.set(findImg, { zIndex: 1 });
            },
          }
        );
      });
  ...
  function showcaseFullscreenWall() {
    ...
    project.on("mouseenter", function () {
      ...
      new SplitText(".fw-cat", { type: "chars", charsClass: "fw-cat-char" });
      ...
      gsap.to(imgWrap, {
        ...
        width: "100%",
        onStart: function () {
          gsap.set(imgWrap, { left: "unset", right: 0 });
        },
      });
      gsap.fromTo(
        img,
        { duration: 0.7, x: "30%", scale: 1.1 },
        { x: "0%", scale: 1 }
      );
    });
    project.on("mouseleave", function () {
      ...
      gsap.to(imgWrap, {
        ...
        overwrite: true,
        onStart: function () {
          gsap.set(imgWrap, { right: "unset", left: 0 });
        },
      });
      gsap.fromTo(
        img,
        { duration: 0.7, x: "0%", scale: 1 },
        { x: "-30%", scale: 1.1 }
      );
  ...
  function showcaseWall() {
    ...
    gsap.set(wallImg, { width: wallImagesWidth });
    wallProject.on("mouseenter", function () {
      ...
      gsap.fromTo(
        ...
        { opacity: 0 },
        {
          ...
          ease: "power2.Out",
          onStart: function () {
            gsap.set(findImage, { visibility: "visible" });
          },
        }
      );
    });
    wallProject.on("mouseleave", function () {
      ...
      gsap.fromTo(
        ...
        { opacity: 1 },
        {
          ...
          ease: "power2.In",
          onComplete: function () {
            gsap.set(findImage, { visibility: "hidden" });
          },
        }
      );
    });
    ...
    let wpTop = gsap.to(".wall-projects-top", { x: -topTrans - 400 });
  ...
  function alitohServicesS1() {
    ...
    if (services.length) {
      service.each(function () {
        ...
        new SplitText(content, { type: "lines", linesClass: "cont-line" });
      });
  ...
  function aliothServicesS2() {
    if ($(".alioth-services").length) {
      ...
      service.on("click", function () {
        ...
        if ($this.hasClass("active")) {
          $this.removeClass("active");
          gsap.to(content, 0.3, { height: 0, ease: "power2.Out", delay: 0.3 });
          gsap.to(contentInner, 0.3, { opacity: 0 });
        } else {
          service.removeClass("active");
          $this.addClass("active");
          ...
          gsap.to(contentInner, 0.3, { opacity: 1, delay: 0.2 });
          gsap.to(otherContent, 0.3, { height: 0, ease: "power2.Out" }, 0.15);
          gsap.to(otherInner, 0.3, { opacity: 0 });
        }
      });
    }
  }
    ...
    aph.each(function () {
      ...
      if (willAnim == true) {
            ...
            onComplete: function () {
              ...
              if (!mobileQuery.matches) {
                $this.on("mousemove", function (e) {
                  ...
                  gsap.to(names, { x: -mouseLeft / 10, duration: 0.6 });
                  gsap.to(".aph-image", { x: -mouseLeft / 20, duration: 0.6 });
                });
              }
            },
          },
        ...
        aphWelcome.fromTo(
          ...
          1,
          { y: "100%" },
          { y: "0%", stagger: 0.02, ease: "power2.out" },
          0
        );
        aphWelcome.fromTo(
          ".aph_sub_line span",
        ...
        aphWelcome.fromTo(
          ...
          { width: 0, height: 0 },
          {
            ...
            ease: "power2.inOut",
            onComplete: function () {
              gsap.to(".circular-button span", { opacity: 1 });
            },
          },
          1.5
        );
  ...
  function alitohNumberCt() {
    ...
    aCount.each(function () {
      ...
      gsap.set(signSpan, { y: "100%", display: "block" });
      ...
      if (!mobileQuery.matches) {
        if (imgParallax === "true") {
          if (parallaxType === "zoom") {
            ...
            gsap.set($this, { height: finalHeight });
            gsap.set(img, { y: -100 });
            gsap.to(img, {
              scale: 1.25,
              scrollTrigger: {
  ...
  function alitohImageCarousel() {
    ...
    imageCarousel.each(function (i) {
      ...
      var carouselContainer = $this.children(".swiper-container"),
        aImageCr = aImageCr + i;
      var aImageCr = new Swiper(carouselContainer, { slidesPerView: 2 });
    });
  }
  ...
  function aliothTestimonials() {
    ...
    testimonials.each(function () {
      ...
      activeTest = $(".a-testimonial.active");
      gsap.set(wrapper, { height: activeTest.outerHeight() });
      next.on("click", function (i) {
        checkTestimonals();
        gsap.to(wrapper, { height: nextTest.outerHeight() });
        gsap.fromTo(
          testSpans,
          0.75,
          { y: "0%" },
          {
            ...
            onComplete: function () {
              ...
              gsap.fromTo(
                ...
                0.6,
                { y: "110%" },
                { y: "0%", stagger: 0.05, ease: "power2.Out" }
              );
            },
          }
        );
      ...
      prev.on("click", function (i) {
        checkTestimonals();
        gsap.to(wrapper, { height: prevTest.outerHeight() });
        gsap.fromTo(
          testSpans,
          0.75,
          { y: "0%" },
      ...
      if ($this.hasClass("autoplay")) {
        ...
        let testAutPlay = gsap.fromTo(
          ...
          { width: "0%" },
          {
            ...
            repeat: -1,
            ease: "none",
            scrollTrigger: { trigger: testimonials, start: "top bottom" },
            onRepeat: function () {
              next.trigger("click");
            },
          }
  ...
  function aliothSeperator() {
    ...
    seperator.each(function () {
      let $this = $(this),
        ...
        willAnim = $this.data("anim");
      gsap.set($this, { backgroundColor: bgColor });
      if (willAnim == true) {
        gsap.to($this, 1.5, {
          width: "100%",
          scrollTrigger: { trigger: $this },
  ...
  function aliothButtons() {
    ...
    aButton.each(function () {
      ...
      if ($this.hasClass("style_1")) {
        ...
        $this.on("mouseenter", function (e) {
          ...
          gsap.to(overlayIn, { width: "100%", height: "100%" });
        });
        $this.on("mouseleave", function (e) {
          gsap.to(overlayIn, { width: "0%", height: "0%" });
        });
      }
    });
    ...
    scrollNot.on("click", function () {
      ...
      gsap.to(window, { duration: 3, scrollTo: target, ease: "power2.out" });
    });
  }
    ...
    heading.each(function () {
      ...
      if (parallax == true) {
        ...
        if (image == true) {
          ...
          gsap.to(img, {
            y: -100,
            scrollTrigger: { trigger: $this, start: "top bottom", scrub: true },
          });
          gsap.to(title, {
            y: 100,
            scrollTrigger: { trigger: $this, start: "top bottom", scrub: true },
  ...
  function aliothRecentWorks() {
    ...
    recentWorkCarousel.each(function () {
      ...
      if (navType === "scroll") {
        ...
        var scrollAn = gsap.to(wrapper, { x: "-" + wrapTransVal });
  ...
  function aliothLinkedText() {
    ...
    linkedText.each(function () {
      ...
      links.on("mouseenter", function () {
        ...
        gsap.to(linkWords, { y: "-110%", ease: "power2.inOut" });
        gsap.to(linkSpan, { y: "-100%", ease: "power2.inOut" });
      });
      links.on("mouseleave", function () {
        let $this = $(this),
          linkWords = $this.find("div"),
          linkSpan = $this.find(".link-target");
        gsap.to(linkWords, { y: "0%" });
        gsap.to(linkSpan, { y: "0%" });
      });
  ...
  function aliothTeamCarousel() {
    ...
    aliothTeam.each(function () {
      ...
      var teamCarousel = new Swiper(".team-container", {
        slidesPerView: "auto",
        navigation: { nextEl: ".prev" },
        spaceBetween: 15,
        pagination: { el: ".team-progress", type: "progressbar" },
        grabCursor: true,
      });
  ...
  function aliothShowcaseList() {
    ...
    listProject.each(function (i) {
      ...
      $this.on("mouseenter", function () {
        ...
        gsap.set(findImg, { visibility: "visible" });
        listProject.addClass("opdown");
        $this.removeClass("opdown");
        $(findImg).addClass("active");
      });
      $this.on("mouseleave", function () {
        gsap.set(".sl-project-image", { visibility: "hidden" });
    ...
    let listScroll = gsap.to(wrapper, { y: "-100%" });
    ScrollTrigger.create({
      trigger: wrapper,
      start: "top top",
      end: "bottom+=1000 top",
    ...
    ScrollTrigger.create({
      ...
      onLeave: function () {
        gsap.to(".showcase-footer", { opacity: 0 });
      },
    });
    window.addEventListener("mousemove", function (event) {
      let x = event.clientX,
        y = event.clientY;
      gsap.to(".sl-images", { top: y, left: x });
    });
  }
  function aliothShowcaseFullscrenSlider() {
    ...
    var fsSlider = new Swiper(".fs-images", {
      ...
      loop: false,
      breakpoints: { 450: { allowTouchMove: false } },
      pagination: { el: ".fs-prog", type: "progressbar" },
      slidesPerView: 1,
    ...
    fsSlider.on("slideNextTransitionStart", function () {
      ...
      slideNextOut.fromTo(
        ...
        0.6,
        { x: 0 },
        { x: -100, stagger: 0.01, ease: "power1.in" },
        0
      );
      slideNextOut.fromTo(
        ".fs-fraction span",
    ...
    fsSlider.on("slideNextTransitionEnd", function () {
      ...
      slideNextIn.fromTo(
        ...
        0.5,
        { x: 100 },
        { x: 0, stagger: 0.01, ease: "power1.out" },
        0
      );
      slideNextIn.fromTo(
        ".fs-fraction span",
  ...
  function aliothShowcaseCarousel() {
    var project = $(".cas-project"),
      ...
      activeProject;
    new SplitText(headline, { type: "lines", linesClass: "cas-line" });
    project.each(function (i) {
      i++;
      let $this = $(this),
    ...
    let csw = gsap.fromTo(
      ...
      css = new ScrollTrigger({
        ...
        onUpdate: function (self, progress) {
          ...
          gsap.to(prog, { width: self.progress * 100 + "%" });
          project.each(function () {
            let $this = $(this);
          });
        },
        ...
        onEnterBack: function () {
          gsap.to(".showcase-footer", { opacity: 1 });
        },
      });
  ...
  function aliothShowcaseSlide() {
    ...
    projects.each(function (i) {
      ...
      new SplitText(summary, { type: "lines", linesClass: "ssum-line" });
      new SplitText(cat, { type: "chars", charsClass: "cat_char" });
      new SplitText(title, {
        type: "lines , chars",
        linesClass: "st-line",
        charsClass: "st-char",
      ...
      new SplitText(date, { type: "chars", charsClass: "sd-char" });
    ...
    var prjectsSlider = new Swiper(".ss1-images", {
      slidesPerView: 1,
      speed: 1000,
      navigation: { nextEl: ".ss1-next", prevEl: ".ss1-prev" },
      pagination: {
        el: ".ss1-dots",
        type: "bullets",
        clickable: true,
      ...
      mousewheel: { invert: false, eventsTarget: ".showcase-slideshow" },
      loop: true,
      direction: "vertical",
      on: {
        ...
        slidePrevTransitionStart: function () {
          let slidePrevOut = gsap.timeline({ yoyo: true });
          slidePrevOut.fromTo(
            prevImage,
            1.5,
            { rotate: -5, scale: 1.2 },
            { rotate: 0, scale: 1, ease: "power2.out" },
            0
          );
          slidePrevOut.fromTo(
            catChars,
            0.5,
            { y: "0%" },
            { y: "100%", ease: "power2.in", stagger: -0.01 },
            0
          );
          slidePrevOut.fromTo(
            sumLines,
            0.6,
            { y: "0%" },
            { y: "100%", stagger: -0.02, ease: "power2.in" },
            0.3
          );
          lines.each(function () {
            slidePrevOut.fromTo(
              ...
              0.6,
              { y: "0%" },
              { y: "110%", ease: "power2.in", stagger: -0.01 },
              0
            );
          });
        },
        slidePrevTransitionEnd: function () {
          slideCheck();
          let slidePrevIn = gsap.timeline({ yoyo: true });
          slidePrevIn.fromTo(
            catChars,
            0.5,
            { y: "-100%" },
            { y: "0%", ease: "power2.out", stagger: 0.01 },
            0
          );
          slidePrevIn.fromTo(
            sumLines,
        ...
        slideNextTransitionStart: function () {
          let slideNextOut = gsap.timeline({ yoyo: true });
          slideNextOut.fromTo(
            nextImage,
            1.5,
            { rotate: 5, scale: 1.2 },
        ...
        slideNextTransitionEnd: function () {
          slideCheck();
          let slideNextIn = gsap.timeline({ yoyo: true });
          slideNextIn.fromTo(
            catChars,
            0.5,
            { y: "100%" },
          ...
          lines.each(function () {
            slideNextIn.fromTo(
              ...
              0.6,
              { y: "110%" },
              { y: "0%", opacity: 1, ease: "power2.out", stagger: 0.01 },
              0
            );
          });
        },
  ...
  function aliothShowcaseSlideV2() {
    ...
    new SplitText(backText, { type: "chars", charsClass: "bt-char" });
    ...
    ss2Project.each(function (i) {
      ...
      $this.attr("data-index", i);
      $this.addClass("slide_" + i);
      new SplitText(excerpt, { type: "lines", linesClass: "excerpt-line" });
    ...
    new SplitText(".ss2-back-text", { type: "chars", charsClass: "bt-char" });
    $(".bt-char").wrapInner("<span></span>");
    ...
    var ss2ImagesSlider = new Swiper(".ss2-images", {
      mousewheel: { invert: false, eventsTarget: ".showcase-slideshow-v2" },
      ...
      slidesPerView: 1,
      navigation: { nextEl: ".ss2-next", prevEl: ".ss2-prev" },
      speed: 1000,
      parallax: true,
      watchSlidesProgress: true,
      on: {
    ...
    var ss2ScrollAnim = gsap.timeline({ yoyo: true });
    ...
    let scrolla = new ScrollTrigger({
      ...
      onUpdate: function (self, progress) {
        ...
        boxSet({ cssRule: { opacity: self.progress } });
      },
      onLeaveBack: function () {},
    });
    ...
    ss2ImagesSlider.on("slideChange", function () {
      ...
      slideOut.fromTo(
        catSpan,
        { y: "0%" },
        { y: "-100%", ease: "power2.in" },
        0
      );
      slideOut.fromTo(
        titleChar,
        { y: "0%" },
        { y: "-100%", stagger: 0.01, ease: "power2.in" },
        0.1
      );
      slideOut.fromTo(
        excerptLine,
      ...
      slideOut.fromTo(
        backChars,
        { x: 0 },
        { x: -150, stagger: 0.02, ease: "power2.in" },
        0
      );
    });
    ss2ImagesSlider.on("slideChangeTransitionEnd", function () {
      ...
      slideIn.fromTo(
        excerptLine,
        { y: "100%" },
        { y: "0%", stagger: 0.01, ease: "power2.out" },
        0
      );
      slideIn.fromTo(
        catSpan,
      ...
      slideIn.fromTo(
        backChars,
        { x: 150 },
        { x: 0, stagger: 0.02, ease: "power2.out" },
        0
      );
    });
      ...
      if (anim === "linesFadeUp") {
        gsap.fromTo(
          ...
          { y: "100%", opacity: 0 },
          {
            ...
            duration: duration,
            stagger: stagger,
            scrollTrigger: { trigger: parent, position: "top top" },
            delay: delay,
            ease: "expo.out",
            onComplete: function () {
              splitto.revert();
        ...
        gsap.fromTo(
          ...
          { y: "100%" },
          {
            ...
            duration: duration,
            stagger: stagger,
            scrollTrigger: { trigger: parent, start: "top bottom" },
            delay: delay,
            ease: "power4.out",
            onComplete: function () {
              splitto.revert();
        ...
        gsap.fromTo(
          ...
          { y: 50, opacity: 0 },
          {
            ...
            duration: duration,
            stagger: stagger,
            scrollTrigger: { trigger: parent, start: "top center" },
            delay: delay,
            onComplete: function () {
              splitto.revert();
            },
    ...
    imAnim.each(function (i) {
      ...
      if (anim === "blockUp" || anim === "blockLeft" || anim === "blockRight") {
        ...
        gsap.to($this, {
          ...
          duration: duration * 2,
          delay: delay,
          scrollTrigger: { trigger: parWrap, start: "top center" },
          ease: "power3.out",
        });
        if (anim === "blockUp") {
          gsap.set(animOv, { background: ovColor });
          gsap.to(animOv, {
            height: "0%",
            delay: delay,
            scrollTrigger: { trigger: parWrap, start: "top center" },
        ...
        if (anim === "blockRight") {
          gsap.set(animOv, { left: "unset", background: ovColor });
          gsap.to(animOv, {
            width: "0%",
            delay: delay,
            scrollTrigger: { trigger: parWrap, start: "top center" },
        ...
        gsap.to($this, {
          ...
          duration: duration * 2,
          delay: delay,
          scrollTrigger: { trigger: parWrap, start: "top 85%" },
          ease: "power3.out",
        });
        if (anim === "slideUp") {
          gsap.set($this, { left: 0, top: 0 });
          ...
          gsap.set($this, { left: "unset", right: 0 });
    ...
    if (showcaseCheck.length > 0) {
      if (showcaseCheck.hasClass("showcase-list")) {
        ...
        scWelcome.fromTo(
          ...
          1,
          { y: "100%" },
          { y: "0%", ease: "power2.out", stagger: 0.05 },
          1
        );
        var slBef = CSSRulePlugin.getRule(".sl-project::before");
        scWelcome.to(slBef, 0.4, { cssRule: { opacity: 1 } }, 1.3);
        scWelcome.fromTo(
          ".showcase-footer",
          0.6,
          { opacity: 0 },
        ...
        var ss2Welcome = gsap.timeline({ once: true });
        ss2Welcome.fromTo(
          ".title-char",
          1,
          { y: "100%" },
        ...
        ss2Welcome.fromTo(".ss2-nav", 0.5, { opacity: 0 }, { opacity: 1 }, 1);
        ss2Welcome.fromTo(
          ".showcase-footer",
          0.5,
          { opacity: 0 },
        ...
        let ssWelcome = gsap.timeline({
          ...
          onStart: function () {
            disableScroll();
            gsap.set(".ss-project.active .ss1-cat", { visibility: "hidden" });
        ...
        ssWelcome.fromTo(
          ...
          0.7,
          { width: 0 },
          { width: butWidth, ease: "power2.inOut" },
          1.3
        );
        ssWelcome.fromTo(
          ".ssum-line",
        ...
        sCarouselWelcome.fromTo(
          ...
          1,
          { y: "100%" },
          { y: "0%", stagger: 0.1, ease: "power3.out" },
          2
        );
        sCarouselWelcome.fromTo(
          wrapper,
          2.5,
          { x: wrapWidth },
          { x: wrapFirstTrans, ease: "circ.inOut" },
          0.2
        );
        sCarouselWelcome.fromTo(
          ".cas-bg-text",
        ...
        let welcomeAnim = gsap.timeline({ once: true }),
          currentSlide = $(".swiper-slide-active"),
          nextSlide = $(".swiper-slide-next"),
          prevSlide = $(".swiper-slide-prev"),
          actImg = $(currentSlide).find("img"),
        ...
        welcomeAnim.fromTo(
          ...
          1.5,
          { x: -100 },
          { x: -0, stagger: 0.01, ease: "power2.out" },
          0.3
        );
        welcomeAnim.fromTo(
          ".fs-fraction span",
        ...
        let fsWallWelcome = gsap.timeline({ once: true }),
        ...
        fsWallWelcome.fromTo(
          ...
          1.5,
          { cssRule: { y: "150%" } },
          { cssRule: { y: "0%" }, stagger: 0.1, ease: "power2.out" },
          1
        );
        fsWallWelcome.fromTo(
          ".showcase-footer",
  ...
  barba.init({
    ...
    transitions: [
          ...
          return new Promise(function (resolve, reject) {
            ...
            if (siteHeader.hasClass("menu-has-open")) {
              ...
              fsMenuTrans.to(
                menuItems,
                1,
                { y: "-100%", stagger: 0.05, ease: "power2.in" },
                0
              );
              fsMenuTrans.to(
                ".menu-widget .social-list li a",
                1,
                { y: "-100%", opacity: 0, stagger: 0.05, ease: "power2.in" },
                0
              );
              fsMenuTrans.fromTo(
                ".trans_char",
                ...
                { y: "100%" },
                {
                  ...
                  onStart: function () {
                    ...
                    let tl = gsap.timeline({ once: true, delay: 0.5 });
                    tl.to(".trans_char", {
                      color: secondColor,
                      duration: 0.3,
                      stagger: 0.02,
              ...
              fsMenuTrans.to(
                menuOv,
                0.5,
                { cssRule: { height: "100vh" }, ease: "none" },
                0.1
              );
            } else {
              ...
              defaultTransOut.fromTo(
                ...
                { height: "0%" },
                {
                  ...
                  ease: "power2.inOut",
                  onStart: function () {
                    gsap.set(bg, { top: "unset", bottom: 0 });
                  },
                },
                0
              );
          ...
          return new Promise(function (resolve, reject) {
            ...
            if (siteHeader.hasClass("menu-has-open")) {
              gsap.fromTo(
                ...
                0.75,
                { y: "0%" },
                { ease: "power2.in", y: "-100%", stagger: 0.01, delay: 0.35 }
              );
              ...
              gsap.to(menuOv, 0.75, {
                ...
                onComplete: function () {
                  gsap.set(trans, { visibility: "hidden" });
                  ...
                  $(".sub-back").removeClass("is-active");
                  enableScroll();
                  gsap.set(menuBackOv, { display: "block" });
              ...
              transOut.fromTo(
                ...
                { height: "100%" },
                {
                  height: "0%",
                  onStart: function () {
                    gsap.set(bg, { top: 0, bottom: "unset" });
                  },
                  ease: "power2.inOut",
                },
                0.5
              ...
              transOut.fromTo(
                ...
                0.75,
                { y: "0%" },
                { ease: "power2.in", y: "-100%", stagger: 0.01 },
                0
              );
            }
          });
            ...
            fsImageTrans.fromTo(
              ...
              { opacity: 1 },
              {
                ...
                onComplete: function () {
                  ...
                  gsap.set(".trans-image", { width: "100%", height: "100%" });
                },
              },
              0.3
            );
        ...
        leave() {
          return new Promise(function (resolve, reject) {
            ...
            scImageTrans.fromTo(
              ...
              1,
              { y: "0%" },
              { y: "-110%", stagger: 0.01, ease: "power1.in" },
              0
            );
            scImageTrans.fromTo(
              ".cas-progress",
              ...
              { opacity: 1 },
              {
                ...
                onComplete: function () {
                  ...
                  imageHalf.to(".trans-image", 1, {
                    ...
                    height: "100%",
                    onComplete: function () {
                      gsap.set(".trans-image", { y: "0%", top: "0%" });
                      resolve();
                    },
                  });
                },
        ...
        leave() {
          return new Promise(function (resolve, reject) {
            ...
            scImageTrans.fromTo(
              ...
              1,
              { cssRule: { y: "0%" } },
              { cssRule: { y: "-150%" }, stagger: 0.05, ease: "power1.in" },
              0.2
            );
            scImageTrans.fromTo(
              ".showcase-footer",
        ...
        leave() {
          return new Promise(function (resolve, reject) {
            ...
            scImageTrans.to(
              ".wall-projects-bottom",
              2,
              { x: "-100%", stagger: 0.05, ease: "power2.inOut" },
              0
            );
            scImageTrans.to(
              ".wall-drag",
              1,
              { width: "0%", ease: "power2.inOut" },
              0
            );
            scImageTrans.fromTo(
              ".showcase-footer",
      ...
      },
      {
        ...
        leave() {
          return new Promise(function (resolve, reject) {
            ...
            scImageTrans.to(cat, 0.4, { y: "-100%", ease: "power2.in" }, 0);
            scImageTrans.to(
              summLines,
              0.75,
              { y: "-100%", stagger: 0.05, ease: "power2.in" },
            ...
            scImageTrans.to(
              ".ss2-dot",
              0.5,
              { x: "-30", opacity: 0, stagger: 0.05, ease: "power2.in" },
              0
            );
            scImageTrans.to(
              ".ss2-nav",
        ...
        leave() {
          return new Promise(function (resolve, reject) {
            ...
            scImageTrans.to(
              ".sl-project-meta",
              0.6,
              { y: "100%", ease: "power2.in", stagger: 0.05 },
              0
            );
            var slBef = CSSRulePlugin.getRule(".sl-project::before");
            scImageTrans.to(slBef, 0.4, { cssRule: { opacity: 0 } }, 0);
            scImageTrans.to(
              ".showcase-footer",
              0.4,
              {
        ...
        leave() {
          return new Promise(function (resolve, reject) {
            ...
            ppTitleOut.fromTo(
              ...
              0.75,
              { y: "100%" },
              { y: "0%", ease: "power2.out", y: "0%", stagger: 0.01 },
              0.45
            );
          });
        },
      ...
      },
      {
        ...
        from: { namespace: ["pph1", "pph2", "pph3", "pph-video"] },
        to: { namespace: ["pph1", "pph2", "pph3", "pph-video"] },
        leave() {
          return new Promise(function (resolve, reject) {
            var title = $(".next-project-title").text();
            var trans = $(".alioth-page-transitions"),
            ...
            ppTitleOut.fromTo(
              ...
              1,
              { y: "100%" },
              { y: "0%", stagger: 0.025, ease: "power2.out" },
              0.45
            );
          });
        },
